...
const quizQuestions = [
    ...
    {
        question: "Warum könnte ein Handelsdefizit KEIN wirtschaftliches Problem sein?",
        answers: [
            "Weil Defizite automatisch durch Inflation ausgeglichen werden",
            "Weil günstige Importe den Verbrauchern nützen und Kapitalzuflüsse die Wirtschaft stärken können",
            "Weil die WTO Defizite ausgleicht",
            "Weil Handelsdefizite in der Praxis nicht vorkommen"
        ],
        correct: 1,
        explanation: "Ein Handelsdefizit bedeutet günstige Importe für Verbraucher. Gleichzeitig fließt Kapital ins Land (z.B. ausländische Investitionen), was Wachstum fördern kann. Die USA haben seit Jahrzehnten ein Defizit bei gleichzeitig starkem Wirtschaftswachstum."
    },
    {
    ...
    {
        question: "Warum können Erziehungszölle langfristig kontraproduktiv wirken, selbst wenn sie kurzfristig funktionieren?",
        answers: [
            "Weil die WTO sie nach 5 Jahren automatisch aufhebt",
            "Weil geschützte Industrien weniger Innovationsdruck haben und ineffizient bleiben können",
            "Weil andere Länder immer sofort Vergeltungszölle erheben",
            "Weil Erziehungszölle nur auf Bildungsprodukte anwendbar sind"
        ],
        correct: 1,
        explanation: "Ohne internationalen Wettbewerbsdruck fehlt der Anreiz zur Innovation. Die gesch\u00fctzte Industrie kann sich an den Schutz \u201Egew\u00f6hnen\u201C und nie wettbewerbsf\u00e4hig werden \u2013 ein Problem, das \u00d6konomen als \u201Einfant industry problem\u201C bezeichnen."
    },
    {
        question: "Welches ökonomische Argument spricht GEGEN Anti-Dumping-Zölle auf chinesischen Stahl?",
        answers: [
            "Anti-Dumping-Zölle sind völkerrechtlich verboten",
            "Sie schützen ineffiziente heimische Produzenten und erhöhen die Kosten für stahlverarbeitende Industrien wie den Automobilbau",
            "China hat gar keine Überkapazitäten im Stahlsektor",
            "Die WTO erlaubt Dumping ausdrücklich"
        ],
        correct: 1,
        explanation: "Anti-Dumping-Zölle schützen zwar Stahlarbeiter, aber verteuern Stahl für Autobauer, Maschinenbauer und Bauunternehmen. Die Folgejobs in diesen Branchen überwiegen oft die geschützten Stahljobs – ein klassisches Dilemma der Handelspolitik."
    },
    {
    ...
    {
        question: "Was versteht man unter \u201EZolleskalation\u201C (tariff escalation) im handelspolitischen Sinne?",
        answers: [
            "Die gegenseitige Erhöhung von Vergeltungszöllen zwischen zwei Ländern",
            "Höhere Zölle auf verarbeitete Produkte als auf Rohstoffe, um Wertschöpfung im Inland zu halten",
            "Die schrittweise Abschaffung von Zöllen durch WTO-Verhandlungen",
            "Die automatische Anpassung von Zöllen an die Inflation"
        ],
        correct: 1,
        explanation: "Zolleskalation bedeutet: Auf Rohstoffe fallen niedrige/keine Zölle an, auf verarbeitete Produkte steigen sie stufenweise. Beispiel: Rohkaffee 0%, gerösteter Kaffee 7,5%. Dies hält Entwicklungsländer in der Rolle als Rohstofflieferanten."
    },
    {
    ...
    {
        question: "Warum zielen EU-Vergeltungszölle oft auf Bourbon-Whiskey und Harley-Davidson statt auf strategisch wichtige US-Güter?",
        answers: [
            "Weil diese Produkte besonders umweltschädlich sind",
            "Weil die EU gezielt Produkte aus Wahlkreisen einflussreicher US-Politiker trifft, um politischen Druck zu erzeugen",
            "Weil es keine strategisch wichtigen US-Güter gibt",
            "Weil die WTO nur Zölle auf Konsumgüter erlaubt"
        ],
        correct: 1,
        explanation: "Die EU wählt Vergeltungszölle strategisch: Bourbon kommt aus Kentucky (Senator McConnell), Harley-Davidson aus Wisconsin. Durch gezielten Druck auf einflussreiche Wahlkreise soll die US-Regierung zum Einlenken bewegt werden."
    },
    {
...
const lexikonEntries = [
    ...
    },
    {
        ...
        example: "Seltene Erden sind strategisch wichtige Rohstoffe f\u00fcr Smartphones, Elektroautos und Chips \u2013 und China kontrolliert den Gro\u00dfteil der weltweiten F\u00f6rderung und Verarbeitung. Ein protektionistischer Staat k\u00f6nnte hohe Z\u00f6lle auf diese Rohstoffe erheben, um heimische Produzenten wettbewerbsf\u00e4higer zu machen. Trumps \u201ELiberation Day\u201C-Zollstrategie mit hohen Z\u00f6llen auf chinesische Produkte ist ein aktuelles Beispiel. Allerdings steigen dadurch die Produktionskosten f\u00fcr Hersteller von Elektroautos oder Windkraftanlagen, was zu h\u00f6heren Preisen f\u00fcr Verbraucher f\u00fchrt."
    },
    {
        term: "Handelsdefizit",
    ...
    },
    {
        ...
        example: "Der Handelskrieg zwischen den USA und China, der 2018 begann und sich 2025 massiv versch\u00e4rfte, zeigt exemplarisch, wie solche Konflikte eskalieren. Trump erh\u00f6hte die Z\u00f6lle schrittweise auf schlie\u00dflich 145 % im April 2025; China konterte mit 125 %. Amerikanische Farmer verloren einen ihrer gr\u00f6\u00dften Absatzm\u00e4rkte \u2013 die Sojabohnen-Exporte nach China brachen um \u00fcber 70 % ein. Gleichzeitig stiegen die Preise in US-Superm\u00e4rkten f\u00fcr Elektronik und Kleidung deutlich an. Am Ende schadete der Handelskrieg beiden Volkswirtschaften."
    },
    {
        ...
        example: "CETA zwischen der EU und Kanada zeigt die konkreten Auswirkungen von Freihandelsabkommen. Vor CETA zahlten europ\u00e4ische Autohersteller beim Export nach Kanada 6,1 % Zoll \u2013 bei einem 60.000-\u20ac-Fahrzeug \u00fcber 3.600 \u20ac zus\u00e4tzlich. Diese Z\u00f6lle wurden komplett abgeschafft; umgekehrt kann Kanada bis zu 50.000 Tonnen Rindfleisch zollfrei in die EU exportieren. Der bilaterale Handel stieg um etwa 30 %. Allerdings bleibt CETA umstritten: Kritiker bef\u00fcrchten, dass kanadische Agrarstandards europ\u00e4ische Verbraucherschutzregeln unterlaufen k\u00f6nnten."
    },
    {
        term: "Schutzzoll",
    ...
    },
    {
        ...
        example: "Ab 2026 m\u00fcssen EU-Importeure von Stahl, Aluminium, Zement und D\u00fcngemitteln CBAM-Zertifikate kaufen, deren Preis dem EU-Emissionshandelspreis (ca. 60\u201390 \u20ac/Tonne CO\u2082) entspricht. Ein deutsches Bauunternehmen, das t\u00fcrkischen Stahl importiert, muss f\u00fcr jede Tonne CO\u2082 bei der Herstellung ein Zertifikat erwerben \u2013 das k\u00f6nnte den Preis um 100\u2013200 \u20ac pro Tonne erh\u00f6hen. Europ\u00e4ische Stahlhersteller begr\u00fc\u00dfen CBAM, da es ihren Kostennachteil durch strenge EU-Klimapolitik ausgleicht. Schwellenl\u00e4nder wie Indien kritisieren es jedoch als \u201Egr\u00fcnen Protektionismus\u201C."
    },
    {
    ...
    {
        term: "Zolleskalation (Tariff Escalation)",
        definition: "Handelspolitische Praxis, bei der auf Rohstoffe niedrige oder keine Zölle erhoben werden, auf verarbeitete Produkte aber zunehmend höhere. Dies hält Entwicklungsländer in der Rolle als Rohstofflieferanten.",
        example: "Die EU erhebt auf Rohkaffee 0 % Zoll, auf gerösteten Kaffee aber 7,5 %. Dadurch lohnt es sich für Anbauländer wie Äthiopien oder Brasilien nicht, den Kaffee selbst zu rösten und als Fertigprodukt zu exportieren – die profitable Wertschöpfung bleibt in Europa. Kritiker sehen darin ein Relikt kolonialer Handelsstrukturen."
    },
    {
        term: "Zoll-Eskalationsspirale",
        definition: "Stufenweise Erhöhung von Zöllen als gegenseitige Vergeltungsmaßnahme zwischen Handelspartnern. Führt oft zu einem Handelskrieg.",
        example: "Die Zoll-Eskalationsspirale zwischen den USA und China 2018–2025 ist ein Lehrbuchbeispiel: Im Januar 2018 begannen die USA mit Zöllen von 30 % auf Solarmodule. China antwortete mit 25 % auf US-Schweinefleisch. In mehreren Runden stiegen die Zölle immer weiter. Nach Trumps Rückkehr ins Amt 2025 eskalierte die Situation dramatisch: Die USA erhoben Zölle von 145 % auf chinesische Waren, China konterte mit 125 %. Der bilaterale Handel brach ein und die Weltwirtschaft geriet unter Druck."
    },
    {
        term: "GATT",
        ...
        example: "Als das GATT 1947 von 23 Staaten unterzeichnet wurde, lagen die durchschnittlichen Zolls\u00e4tze weltweit bei etwa 22 %. In acht Verhandlungsrunden wurden sie schrittweise auf unter 5 % gesenkt. Die bedeutendste war die Uruguay-Runde (1986\u20131994), die erstmals auch Regeln f\u00fcr Dienstleistungshandel und geistiges Eigentum schuf und zur Gr\u00fcndung der WTO 1995 f\u00fchrte. Ohne das GATT w\u00e4re der Anstieg des Welthandels von 58 Mrd. Dollar (1948) auf \u00fcber 6 Billionen Dollar (1994) nicht m\u00f6glich gewesen."
    }
];
